#!/usr/bin/env python3
"""Build SR1010 WireGuard runtime 0.2.1 without embedding live secrets."""
...
def build(out, wireguard_go, wg, dashboard):
    ...
    entries += [
        ...
        ("opt/sr1010-net-runtime/post-upgrade-health.sh", (HERE/"post-upgrade-health.sh").read_bytes(), 0o755, False),
    ]
